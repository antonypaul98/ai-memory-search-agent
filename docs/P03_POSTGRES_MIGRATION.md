...
- Move applicable capture/bookmark relational state to the production Postgres profile.
...
- Extend migration/export/import tooling to the remaining SQLite-backed production state, with safe and idempotent transfer semantics.
